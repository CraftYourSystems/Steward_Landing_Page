  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="font-primary font-medium text-sm sm:text-base tracking-normal text-steward-text-secondary text-center mb-[20px]"
      >
      ...
      <motion.h1
        variants={fadeVariants}
        className="font-secondary font-bold text-[36px] sm:text-[48px] lg:text-[56px] leading-[1.1] text-steward-text-primary text-center max-w-[900px] mx-auto mb-[28px]"
      >
      ...
      <motion.p
        variants={fadeVariants}
        className="font-primary font-regular text-[18px] leading-[1.7] text-steward-text-secondary text-center max-w-[700px] mx-auto mb-[48px]"
      >
...
function CTAGroup() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col sm:flex-row items-center justify-center gap-[20px]"
    >
      ...
      <a
        href="#product"
        className="touch-target flex items-center justify-center w-full sm:w-auto px-[40px] py-[16px] text-base font-medium font-primary border border-steward-text-primary text-steward-text-primary bg-transparent rounded-md hover:bg-steward-text-primary hover:text-steward-canvas focus:outline-none focus-visible:ring-2 focus-visible:ring-steward-focus focus-visible:ring-offset-2 focus-visible:ring-offset-steward-canvas steward-interactive"
      >
        Explore Steward
      </a>
    </motion.div>
